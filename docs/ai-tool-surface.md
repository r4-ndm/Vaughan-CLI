...
### Browser tools (CDP — default off)

Requires agent browser control (Settings **`p`**, `vaughan config agent-browser on`, or
`VAUGHAN_DAPP_BROWSER_CDP_PORT`). Never sign. See [vb-kill-switch.md](vb-kill-switch.md).
