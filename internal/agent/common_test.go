...
import (
	...
	"github.com/r4v3n/vaughan-cli/internal/agent/prompt"
	"github.com/r4v3n/vaughan-cli/internal/agent/tools"
...
func anthropicBuilder(model string) builderFunc {
	return func(t *testing.T, r *recorder.Recorder) (fantasy.LanguageModel, error) {
		provider, err := anthropic.New(
			anthropic.WithAPIKey(os.Getenv("VAUGHAN_ANTHROPIC_API_KEY")),
...
func openaiBuilder(model string) builderFunc {
	return func(t *testing.T, r *recorder.Recorder) (fantasy.LanguageModel, error) {
		provider, err := openai.New(
			openai.WithAPIKey(os.Getenv("VAUGHAN_OPENAI_API_KEY")),
...
func openRouterBuilder(model string) builderFunc {
	return func(t *testing.T, r *recorder.Recorder) (fantasy.LanguageModel, error) {
		provider, err := openrouter.New(
			openrouter.WithAPIKey(os.Getenv("VAUGHAN_OPENROUTER_API_KEY")),
...
func zAIBuilder(model string) builderFunc {
	return func(t *testing.T, r *recorder.Recorder) (fantasy.LanguageModel, error) {
		provider, err := openaicompat.New(
			...
			openaicompat.WithAPIKey(os.Getenv("VAUGHAN_ZAI_API_KEY")),
